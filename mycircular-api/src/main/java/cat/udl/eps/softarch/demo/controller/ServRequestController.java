...
//        System.out.println(username);
        ...
        if (username.equals(currentUser.getUsername())) {
            return servRequestRepository.findByRequester(currentUser);
        }
        ...
        return servRequestRepository.findByRequester(otherUser);
